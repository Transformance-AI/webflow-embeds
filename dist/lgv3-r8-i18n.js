...
function _lgv3P(){var p=(location.pathname||"/").replace(/^\/de(?=\/|$)/,"")||"/";var SM={"loesungen":"solutions","ueber-uns":"about","kontakt":"contact","glossar":"glossary","lexikon":"glossary","anbietervergleich":"compare","bestenlisten":"review","termin-buchen":"meeting","rechner":"tools","forderungsmanagement":"collections","abzugsmanagement":"deductions","liquiditaetsplanung":"cash-flow-forecasting","kundenreferenzen":"customer-stories","dso-rechner":"dso-calculator","liquiditaetsplanung-tool":"cash-flow-forecasting-tool"};var s=p.split("/");for(var i=0;i<s.length;i++){if(SM[s[i]])s[i]=SM[s[i]];}return s.join("/")||"/";}
(function () {
