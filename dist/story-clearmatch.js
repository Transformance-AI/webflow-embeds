...
`,l={"clearmatch-loop":`<div class="relative overflow-hidden"><style>
        ...
        @keyframes calSt1 { 0%,14%{opacity:1;} 18%,100%{opacity:0;} }
        @keyframes calSt2 { 0%,14%{opacity:0;} 18%,54%{opacity:1;} 58%,100%{opacity:0;} }
        @keyframes calSt3 { 0%,54%{opacity:0;} 58%,78%{opacity:1;} 82%,100%{opacity:0;} }
        @keyframes calSt4 { 0%,78%{opacity:0;} 82%,100%{opacity:1;} }
