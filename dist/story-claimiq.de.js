...
`;var c={"claimiq-loop":`<style>
      ...
      </style><div class="tf-cardonly"><div class="tf-card relative w-[620px] shrink-0" style="--card-w:620px"><div class="bg-white rounded-2xl shadow-xl border border-gray-100/80 p-6"><div class="flex items-center gap-3 pb-3.5 mb-3 border-b border-gray-100"><div title="Vero \u2014 thinking" class="flex-shrink-0 " style="width:30px;height:30px;background-color:#111827;border-radius:50%;display:flex;align-items:center;justify-content:center;overflow:hidden;user-select:none"><div style="font-family:&quot;Courier New&quot;, Courier, monospace;color:#6EE7B7;display:flex;font-size:12.6px;line-height:1;font-weight:bold;transition:color 0.3s ease;width:3ch;justify-content:space-between;margin-top:0.05em"><span style="width:1ch;text-align:center;display:inline-block">1</span><span style="width:1ch;text-align:center;display:inline-block">1</span></div></div><span class="relative block h-[24px] w-[280px] min-w-0"><span class="clq-s1 absolute inset-0 text-base font-bold text-gray-900 leading-[24px] whitespace-nowrap">Liest die K\xFCrzungen der Woche</span><span class="clq-s2 absolute inset-0 text-base font-bold text-gray-900 leading-[24px] whitespace-nowrap">Sortiert nach Grund</span><span class="clq-s3 absolute inset-0 text-base font-bold text-gray-900 leading-[24px] whitespace-nowrap">Einspruch bereit</span><span class="clq-s4 absolute inset-0 text-base font-bold text-emerald-800 leading-[24px] whitespace-nowrap">178 Einspr\xFCche erhoben</span></span><span class="ml-auto inline-flex items-center gap-1.5 shrink-0 text-sm font-bold text-amber-700"><span class="clq-pulse w-2 h-2 rounded-full bg-amber-500"></span> Live</span></div><div class="relative" style="height:256px"><svg class="absolute inset-0 pointer-events-none" width="236" height="256" fill="none" aria-hidden="true"><path class="clq-lead0" d="M132,47 C146.4,47 141.6,128 154,128" stroke="#d97706" stroke-opacity="0.45" stroke-width="2" stroke-linecap="round" stroke-dasharray="100" pathLength="100"></path><path class="clq-lead1" d="M132,97 C146.4,97 141.6,128 154,128" stroke="#d97706" stroke-opacity="0.45" stroke-width="2" stroke-linecap="round" stroke-dasharray="100" pathLength="100"></path><path class="clq-lead2" d="M132,147 C146.4,147 141.6,128 154,128" stroke="#d97706" stroke-opacity="0.45" stroke-width="2" stroke-linecap="round" stroke-dasharray="100" pathLength="100"></path><path class="clq-lead3" d="M132,203 C146.4,203 141.6,128 154,128" stroke="#d97706" stroke-opacity="0.8" stroke-width="2.5" stroke-linecap="round" stroke-dasharray="100" pathLength="100"></path></svg><div class="clq-sig0 absolute left-0 flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-2" style="top:27px;width:132px;height:40px"><span class="w-7 h-7 rounded-lg bg-amber-50 text-amber-700 flex items-center justify-center shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search-x h-4 w-4"><path d="m13.5 8.5-5 5"></path><path d="m8.5 8.5 5 5"></path><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.3-4.3"></path></svg></span><span class="text-xs font-semibold text-gray-700 leading-tight">214 K\xFCrzungen</span></div><div class="clq-sig1 absolute left-0 flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-2" style="top:77px;width:132px;height:40px"><span class="w-7 h-7 rounded-lg bg-amber-50 text-amber-700 flex items-center justify-center shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-tags h-4 w-4"><path d="m15 5 6.3 6.3a2.4 2.4 0 0 1 0 3.4L17 19"></path><path d="M9.586 5.586A2 2 0 0 0 8.172 5H3a1 1 0 0 0-1 1v5.172a2 2 0 0 0 .586 1.414L8.29 18.29a2.426 2.426 0 0 0 3.42 0l3.58-3.58a2.426 2.426 0 0 0 0-3.42z"></path><circle cx="6.5" cy="9.5" r=".5" fill="currentColor"></circle></svg></span><span class="text-xs font-semibold text-gray-700 leading-tight">Ihre Abzugsgr\xFCnde</span></div><div class="clq-sig2 absolute left-0 flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-2" style="top:127px;width:132px;height:40px"><span class="w-7 h-7 rounded-lg bg-amber-50 text-amber-700 flex items-center justify-center shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-folder-search h-4 w-4"><path d="M10.7 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v4.1"></path><path d="m21 21-1.9-1.9"></path><circle cx="17" cy="17" r="3"></circle></svg></span><span class="text-xs font-semibold text-gray-700 leading-tight">Vertr\xE4ge &amp; Lieferbelege</span></div><div class="clq-sig3 absolute left-0 flex items-center gap-2 rounded-xl border-2 border-amber-300 bg-white px-2 shadow-sm" style="top:177px;width:132px;height:52px"><span class="w-8 h-8 rounded-lg bg-amber-600 text-white flex items-center justify-center shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-brain h-4 w-4"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"></path><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"></path><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"></path><path d="M17.599 6.5a3 3 0 0 0 .399-1.375"></path><path d="M6.003 5.125A3 3 0 0 0 6.401 6.5"></path><path d="M3.477 10.896a4 4 0 0 1 .585-.396"></path><path d="M19.938 10.5a4 4 0 0 1 .585.396"></path><path d="M6 18a4 4 0 0 1-1.967-.516"></path><path d="M19.967 17.484A4 4 0 0 1 18 18"></path></svg></span><span class="min-w-0 leading-tight"><span class="block text-[10px] font-bold uppercase tracking-wider text-amber-600">Modell</span><span class="block text-xs font-bold text-gray-900 truncate">G\xFCltigkeit</span><span class="block text-[10px] text-gray-400 truncate">was standh\xE4lt</span></span></div><div class="absolute" style="left:186px;top:128px;transform:translate(-50%,-50%);z-index:20"><div class="relative flex items-center justify-center"><span class="clq-ring absolute w-[70px] h-[70px] rounded-full" style="box-shadow:0 0 0 2px rgba(217,119,6,.45)"></span><span class="clq-ring2 absolute w-[70px] h-[70px] rounded-full" style="box-shadow:0 0 0 2px rgba(217,119,6,.45)"></span><div class="relative w-[60px] h-[60px] rounded-full bg-white border-2 border-amber-200 shadow-lg flex items-center justify-center"><div title="Vero \u2014 thinking" class="flex-shrink-0 " style="width:32px;height:32px;background-color:#111827;border-radius:50%;display:flex;align-items:center;justify-content:center;overflow:hidden;user-select:none"><div style="font-family:&quot;Courier New&quot;, Courier, monospace;color:#6EE7B7;display:flex;font-size:13.44px;line-height:1;font-weight:bold;transition:color 0.3s ease;width:3ch;justify-content:space-between;margin-top:0.05em"><span style="width:1ch;text-align:center;display:inline-block">1</span><span style="width:1ch;text-align:center;display:inline-block">1</span></div></div></div></div></div><div class="clq-head absolute top-0 flex items-center justify-between px-1" style="left:236px;right:0"><span class="text-xs font-semibold uppercase tracking-wider text-gray-400">Nach Grund sortiert</span><span class="text-xs font-semibold uppercase tracking-wider text-gray-400">R\xFCckholbar</span></div><div class="clq-row0 absolute flex items-center gap-2.5 rounded-xl border px-3 border-amber-200 bg-amber-50/50" style="left:236px;right:0;top:24px;height:52px"><span class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 bg-amber-100 text-amber-700"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-package-x h-5 w-5"><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14"></path><path d="m7.5 4.27 9 5.15"></path><polyline points="3.29 7 12 12 20.71 7"></polyline><line x1="12" x2="12" y1="22" y2="12"></line><path d="m17 13 5 5m-5 0 5-5"></path></svg></span><span class="min-w-0 leading-tight"><span class="block text-sm font-bold text-gray-900 truncate">Fehlmenge</span><span class="block text-sm text-gray-500">84 F\xE4lle</span></span><span class="clq-amt0 ml-auto shrink-0 text-sm font-bold tabular-nums text-amber-700">\u20AC62k</span></div><div class="clq-row1 absolute flex items-center gap-2.5 rounded-xl border px-3 border-amber-200 bg-amber-50/50" style="left:236px;right:0;top:84px;height:52px"><span class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 bg-amber-100 text-amber-700"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-percent h-5 w-5"><line x1="19" x2="5" y1="5" y2="19"></line><circle cx="6.5" cy="6.5" r="2.5"></circle><circle cx="17.5" cy="17.5" r="2.5"></circle></svg></span><span class="min-w-0 leading-tight"><span class="block text-sm font-bold text-gray-900 truncate">Preis</span><span class="block text-sm text-gray-500">51 F\xE4lle</span></span><span class="clq-amt1 ml-auto shrink-0 text-sm font-bold tabular-nums text-amber-700">\u20AC48k</span></div><div class="clq-row2 absolute flex items-center gap-2.5 rounded-xl border px-3 border-amber-200 bg-amber-50/50" style="left:236px;right:0;top:144px;height:52px"><span class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 bg-amber-100 text-amber-700"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-badge-percent h-5 w-5"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path><path d="m15 9-6 6"></path><path d="M9 9h.01"></path><path d="M15 15h.01"></path></svg></span><span class="min-w-0 leading-tight"><span class="block text-sm font-bold text-gray-900 truncate">Aktion</span><span class="block text-sm text-gray-500">43 F\xE4lle</span></span><span class="clq-amt2 ml-auto shrink-0 text-sm font-bold tabular-nums text-amber-700">\u20AC51k</span></div><div class="clq-row3 absolute flex items-center gap-2.5 rounded-xl border px-3 border-gray-200 bg-gray-50/70" style="left:236px;right:0;top:204px;height:52px"><span class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 bg-gray-200 text-gray-600"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shield-check h-5 w-5"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12 2 2 4-4"></path></svg></span><span class="min-w-0 leading-tight"><span class="block text-sm font-bold text-gray-900 truncate">Schaden</span><span class="block text-sm text-gray-500">36 F\xE4lle</span></span><span class="clq-amt3 ml-auto shrink-0 text-sm font-bold tabular-nums text-gray-400">Berechtigt</span></div></div><div class="clq-total mt-4 flex items-center gap-3 rounded-xl border border-amber-200 bg-amber-50 px-4" style="height:62px"><span class="min-w-0 leading-tight"><span class="block text-sm font-semibold text-amber-700/80">Diese Woche r\xFCckholbar</span><span class="block text-2xl font-bold text-amber-900 tabular-nums">\u20AC161k</span></span><span class="relative ml-auto shrink-0"><span class="clq-btn relative block h-[40px] w-[150px] rounded-xl"><span class="clq-a absolute inset-0 inline-flex items-center justify-center gap-1.5 rounded-xl bg-amber-600 text-sm font-bold text-white">Einspr\xFCche starten</span><span class="clq-b absolute inset-0 inline-flex items-center justify-center gap-1.5 rounded-xl bg-emerald-50 text-sm font-bold text-emerald-700 ring-1 ring-emerald-200"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check h-4 w-4"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg> Gestartet</span></span><svg class="clq-cursor absolute pointer-events-none" style="right:8px;bottom:-2px;width:20px;height:20px;z-index:40" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M5 3l14 8.5-6.2 1.2L10 19 5 3z" fill="#111827" stroke="#fff" stroke-width="1.6" stroke-linejoin="round"></path></svg></span></div></div></div></div>`,"claimiq-resolve":`<style>
